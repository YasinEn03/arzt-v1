...
-- (3) In Windows das Verzeichnis "C:/Zimmermann/volumes/postgres/tablespace/arzt" anlegen
--     Siehe .extras\compose\postgres\compose.yml
-- (4) 2. PowerShell:
--     cd .extras\compose\backend\postgres
--     docker compose exec db bash
--        chown postgres:postgres /var/lib/postgresql/tablespace
--        chown postgres:postgres /var/lib/postgresql/tablespace/arzt
...
-- (7) 2. PowerShell:
--     docker compose exec db bash
--        psql --dbname=postgres --username=postgres --file=/sql/create-db-arzt.sql
--        psql --dbname=arzt --username=arzt --file=/sql/create-schema-arzt.sql
--        exit
...
CREATE ROLE arzt LOGIN PASSWORD 'p';

-- https://www.postgresql.org/docs/current/sql-createdatabase.html
CREATE DATABASE arzt;

GRANT ALL ON DATABASE arzt TO arzt;

-- https://www.postgresql.org/docs/10/sql-createtablespace.html
CREATE TABLESPACE arztspace OWNER arzt LOCATION '/var/lib/postgresql/tablespace/arzt';
