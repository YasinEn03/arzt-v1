...
.ArztQueryResolver für Lesezugriffe an der GraphQL-Schnittstelle
[plantuml,ArztQueryResolver,svg]
----
include::ArztQueryResolver.plantuml[]
----

Donec sollicitudin molestie malesuada. Praesent sapien massa, convallis a
pellentesque nec, egestas non nisi.

.ArztMutationResolver für Schreibzugriffe an der GraphQL-Schnittstelle
[plantuml,ArztMutationResolver,svg]
----
include::ArztMutationResolver.plantuml[]
----
...
."ArztReadService" von der Geschäftslogik
...
."ArztWriteService" von der Geschäftslogik
